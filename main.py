...
# 1. Отримання токена з перевіркою (гарантує, що значення не буде None)
ENV_TOKEN = os.environ.get("BOT_TOKEN")
DEFAULT_TOKEN = "8666795532:AAFICKdumXhvFSVm9GVzRNyZ2UJNMMq9EQg"

BOT_TOKEN = ENV_TOKEN if ENV_TOKEN else DEFAULT_TOKEN
...
def index():
    return "Bot Server is Alive and Ready!", 200
...
# Автоматичне налаштування Webhook при кожному запуску
try:
