...
# Логування для відстеження роботи бота
...
# Збереження вибраної послуги та запит імені
...
# Збереження імені та запит телефону
...
# Завершення запису та відправка сповіщення адміну
async def get_phone(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Сповіщення, яке приходить вам у приватні повідомлення
    admin_message = (
